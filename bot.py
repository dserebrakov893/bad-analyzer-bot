...
WELCOME = (
    "Анализирую *БАД, витамины, лекарства, спортивное питание и функциональные напитки* "
    "по доказательной базе — и нахожу аналог дешевле, обычно в 2–3 раза\\.\n\n"
    "Средний россиянин тратит *4 200 ₽/мес* на витамины и БАДы\\. "
    "Половина из этого — переплата за бренд и маркетинг\\.\n\n"
    "Напиши название или отправь фото этикетки — отвечу структурированно и дам "
...
SCREEN_CHECK = (
    "🔬 *Проверить*\n\n"
    "Что умею анализировать:\n"
    "• *БАД и витамины* — состав, дозы, доказательная база\n"
    "• *Лекарства* — оригинал vs дженерики, цены\n"
    "• *Спортивное питание* — протеин, BCAA, креатин, предтреники\n"
    "• *Функциональные напитки* — реальный состав vs маркетинг\n\n"
    "Напиши название и состав, например:\n"
    "_Омега\\-3 Доппельгерц 1000мг, EPA 180мг DHA 120мг, 30 капсул, 890 руб_\n\n"
    "Или отправь *фото этикетки* — прочитаю состав сам\\.\n\n"
    "Чем больше информации \\(цена, количество\\) — тем точнее анализ\\."
)
